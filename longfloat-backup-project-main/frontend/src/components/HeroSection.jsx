...
//     <img src="/Logo.svg" alt="Unfilled Logo" className="h-8 w-auto" />
//     <span className="text-lg font-semibold text-gray-900">Long Float</span>
//   </div>
...
//               size="lg"
//               variant="outline"
//               className="border-gray-200 hover:border-gray-900 hover:bg-gray-900 hover:text-white px-10 py-6 text-base font-normal rounded-lg transition-all duration-300"
//             >
//               Explore Products
//             </Button>
//           </a>
...
export default function HeroSection() {
  return (
    <section className="hero-section min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-b from-white via-gray-50/30 to-white">
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-12 text-center relative z-10 py-32">
        {/* ⭐ Centered Icon ABOVE hero text */}
        <div className="mb-8 flex items-center justify-center animate-fade-in">
          {/* <img
            src="/Logo.svg"   // ← replace with correct file like /UnfilledLogo.svg
            alt="Hero Logo"
            className="h-14 w-auto mx-auto"
          /> */}
        </div>
      ...
      <style jsx>{`
        ...
        .animate-fade-in-up { animation: fade-in-up 1s ease-out 0.4s both; }
        .animate-fade-in-up-delayed { animation: fade-in-up 1s ease-out 0.6s both; }
        .animate-fade-in-up-delayed-more { animation: fade-in-up 1s ease-out 0.8s both; }
      `}</style>
    </section>
  );
}

        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-gray-100 text-gray-900 mb-8 transition-all duration-500 group-hover:bg-gray-900 group-hover:text-white group-hover:scale-105">
                  <Icon className="w-6 h-6" strokeWidth={1.5} />
                </div>
                <h3 className="text-3xl font-light tracking-tight text-gray-900 mb-4">
                  {feature.title}
                </h3>
